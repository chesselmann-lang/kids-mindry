...
interface Result { hinweise: Hinweis[]; stats: { hasFullName: boolean; hasPhone: boolean; hasAvatar: boolean; completenessPercent: number; role: string } }

const TYP_CONFIG = {
  tipp:   { dot: 'bg-brand-500', bg: 'bg-brand-50',  text: 'text-brand-800'  },
  info:   { dot: 'bg-gray-400',  bg: 'bg-gray-50',   text: 'text-gray-700'   },
  status: { dot: 'bg-green-500', bg: 'bg-green-50',  text: 'text-green-800'  },
}

export default function AiProfil() {
          ...
          <div className="px-4 pb-3">
            ...
            {result && (
              <div className="space-y-2">
                ...
                <p className="text-[10px] text-gray-300 pt-1">KI-Tipps · personalisierte Hinweise</p>
              </div>
            )}
          </div>
        )}
